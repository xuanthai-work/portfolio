...
export const projects: Project[] = [
  ...
  {
    id: "bsche-badminton-scheduler",
    slug: "bsche-badminton-scheduler",
    title: "BSche Badminton Group Scheduler",
    shortDescription:
      "An installable badminton group PWA for scheduling matches, collecting RSVPs, splitting expenses, tracking payments, and sending realtime notifications.",
    fullDescription:
      "A production badminton group management application covering the full match workflow from group invitations and recurring schedules to attendance, expense settlement, payment confirmation, debt tracking, statistics, and multilingual push notifications.",
    businessProblem:
      "Badminton groups needed a shared mobile-friendly workflow to organize matches, confirm attendance, divide session costs, and track outstanding payments without relying on fragmented chat messages and manual calculations.",
    requirements: [
      "Manage groups, members, friends, and approval-based invitations.",
      "Create one-time or weekly recurring matches with venue, court, time, and map details.",
      "Collect member RSVPs and enforce a cutoff before each match.",
      "Split court, shuttlecock, and water expenses between confirmed attendees.",
      "Track submitted and confirmed payments and show member debt summaries.",
      "Synchronize match, RSVP, expense, payment, and notification changes in realtime.",
      "Provide in-app and web push notifications in Vietnamese and English.",
      "Support installation as a mobile PWA.",
    ],
    solution:
      "A Next.js App Router PWA backed by Supabase Auth and Postgres. Row Level Security protects group data, database RPCs handle sensitive multi-table workflows, Realtime channels synchronize clients, and a Vercel API route sends VAPID web push notifications from Supabase webhook events.",
    role: "Full-stack Developer",
    techStack: [
      "Next.js 16",
      "React 19",
    ...
    implementation: [
      "Built group, friendship, invitation, member profile, and username-based sign-in flows.",
      "Implemented one-time and weekly recurring match scheduling with RSVP cutoff enforcement.",
      "Added quick RSVP, admin-added attendee confirmation, and automatic expense re-splitting.",
      "Implemented per-member payment states, admin confirmation, personal debt summaries, and group statistics.",
      "Subscribed match and notification interfaces to Supabase Realtime changes.",
      "Built an installable PWA with update prompts, service-worker push handling, and iOS installation guidance.",
      "Localized the interface and push messages in Vietnamese and English.",
    ],
    technicalDecisions: [
      "Used database RPCs for settlement, invitations, attendance confirmation, and payment transitions that require authorized multi-table updates.",
      "Applied Row Level Security so Realtime delivery and database access remain scoped to authenticated group members.",
      "Generated recurring matches through PostgreSQL cron jobs instead of requiring a continuously running application server.",
      "Kept the service worker focused on push delivery and notification clicks to avoid stale application bundles from offline caching.",
      "Used structured notification data and translated it at presentation time for account-level language preferences.",
    ],
    challenges: [
      "Kept expense splits and payment records consistent when an administrator adds an attendee after a match is settled by recomputing the split inside database functions.",
      "Delivered push notifications across browsers while accounting for the installed-PWA requirement on supported iOS versions.",
      "Coordinated access control across group membership, friendship, invitation, RSVP, and payment workflows using RLS policies and security-definer functions.",
    ],
    results: [
      "Deployed the production application at bscheduler.xyz.",
      "Delivered the complete schedule, RSVP, settlement, payment tracking, and debt-management workflow.",
      "Added realtime synchronization, installable PWA support, and opt-in multilingual web push notifications.",
    ],
    lessonsLearned: ["[Add lesson learned]"],
    architectureImage: placeholderImage,
    coverImage: placeholderImage,
    screenshots: [],
    githubUrl: "https://github.com/xuanthai-work/badminton-schedualer",
    demoUrl: "https://bscheduler.xyz",
    caseStudyUrl: "/projects/bsche-badminton-scheduler",
    featured: true,
    status: "completed",
    startDate: "Jun 2026",
    endDate: "Jun 2026",
